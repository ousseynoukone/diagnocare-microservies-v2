...
create table clinics (created_at timestamp(6), id bigint generated by default as identity, user_id bigint, phone_number varchar(20), address varchar(2552), city varchar(255), name varchar(255), postal_code varchar(255), primary key (id));
