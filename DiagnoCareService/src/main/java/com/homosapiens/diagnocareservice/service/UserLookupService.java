...
import com.homosapiens.diagnocareservice.core.util.EmailHashService;
 ...
 * 
 * IMPORTANT: Always use this service instead of directly calling UserRepository.findByEmail()
